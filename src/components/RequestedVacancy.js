            ...
            <TableBody>
              {currentItems.map((row) => (
                <StyledTableRow key={row.ID}>
                  ...
                  <StyledTableCell align="center">
                    {row.num_of_vacancies}
                  </StyledTableCell>
                  <StyledTableCell align="center">
                    <VacancyPdfDownloadIcon
                      endpointUrl="/download_vacancy-pdf"
                      pdfId={row.pdf_file_id}
                      filename={row.vacancy_id}
                    />
                  </StyledTableCell>
                  <StyledTableCell align="center">
                    <RequestedVacancyIcons ImageType={row.status} />
                  </StyledTableCell>
                  <StyledTableCell align="center">
                    <RequestedVacancyIcons ImageType={row.publish_status} />
                  </StyledTableCell>
                </StyledTableRow>
              ))}
            </TableBody>
